...
def get_olhc_1min(symbol: str, date_start: datetime, date_end: datetime):
    '''
    ...
    (alpaca_paper_endpoint, alpaca_api_key, alpaca_api_secret) = __read_secret()
...
def get_olhc(symbol: str, date_start: datetime, date_end: datetime):
    '''
    Make use of alpaca api to get 1 min of data
    API explanation at: 
