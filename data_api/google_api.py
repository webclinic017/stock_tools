...
def read_spreadsheet(spreadsheet_id, range):
    ...
    credential_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "credentials.json")
...
if __name__ == '__main__':
    ...
    values = read_spreadsheet(SAMPLE_SPREADSHEET_ID, SAMPLE_RANGE_NAME)
